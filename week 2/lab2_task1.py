...
# Verify that the loading is correct: visualize annotations of randomly selected samples in train set
...
# Randomly select several samples to visualise the prediction results
