...
DATASET_IMG_DIR = '/home/group09/code/week5/taskD/input_images/edited_resized'
...
for filename in os.listdir(DATASET_IMG_DIR):
    ...
    outpath = "output_imgs/edited_resized"
    os.makedirs(outpath, exist_ok=True)
    # plt.savefig(os.path.join(outpath,filename))
    cv2.imwrite(os.path.join(outpath,filename), cv2.cvtColor(v.get_image()[:, :, ::-1], cv2.COLOR_BGR2RGB))
